(function () {
    ...
    !function (e, t) {
        var i, n, a = e.layui && layui.define, o = {
            ...
            v: "3.0.3", ie: function () {
            ...
            }(), index: e.layer && e.layer.v ? 100000 : 0, path: o.getPath, config: function (e, t) {
                ...
                var s = "function" == typeof n, f = o.config.skin,
                    c = (f ? f + " " + f + "-msg" : "") || "layui-layer-msg", u = l.anim.length - 1;
        ...
        r.prompt = function (e, t) {
            ...
            if (t = t || {}, t.photos) {
                ...
                }, s.loadi = r.load(1, {shade: !("shade" in t) && 0.9, scrollbar: !1}), o(u[d].src, function (n) {
    ...
    (function (factory) {
        ...
        function spectrum(element, o) {
            var opts = instanceOptions(o, element), flat = opts.flat, showSelectionPalette = opts.showSelectionPalette,
                ...
                resize = throttle(reflow, 10), visible = false, isDragging = false, dragWidth = 0, dragHeight = 0,
...
function loaded() {
    ...
    if (localTheme) {
        ...
        if (data[0] === 1) {
            ...
            $("#content").removeClass().addClass("bg" + data[1]).css("background", data[5]);
            $("header").removeClass().addClass("header-diy" + data[1])
        } else {
            if (data[0] === 2 && data[1] === 8) {
                ...
                if (data[0] === 2 && data[1] === 9) {
                    ...
                    $("#content").removeClass().addClass("bg-diy").css("background", "url(" + data[6] + ") center center / cover no-repeat");
...
function search() {
    ...
    var searchData = {
        ...
        "thisSearchIcon": "url('./assets/images/search_icon.png')",
        "hotStatus": true,
        "data": [{
            name: "百度",
            img: "url('./assets/images/search_icon.png') -80px 0px",
            position: "0px 0px",
            url: "https://www.baidu.com/s?wd="
        }, {
            name: "谷歌",
            img: "url('./assets/images/search_icon.png')  -105px 0px",
            position: "-40px 0px",
            url: "https://www.google.com/search?q="
        }, {
            name: "必应",
            img: "url('./assets/images/search_icon.png')  -80px -25px",
            position: "0px -40px",
            url: "https://cn.bing.com/search?q="
        }, {
            name: "好搜",
            img: "url('./assets/images/search_icon.png') -105px -25px",
            position: "-40px -40px",
            url: "https://www.so.com/s?q="
        }, {
            name: "搜狗",
            img: "url('./assets/images/search_icon.png') -80px -50px",
            position: "0px -80px",
            url: "https://www.sogou.com/web?query="
        }, {
            name: "淘宝",
            img: "url('./assets/images/search_icon.png') -105px -50px",
            position: "-40px -80px",
            url: "https://s.taobao.com/search?q="
        }, {
            name: "京东",
            img: "url('./assets/images/search_icon.png') -80px -75px",
            position: "0px -120px",
            url: "http://search.jd.com/Search?keyword="
        }, {
            name: "天猫",
            img: "url('./assets/images/search_icon.png') -105px -75px",
            position: "-40px -120px",
            url: "https://list.tmall.com/search_product.htm?q="
        }, {
            name: "1688",
            img: "url('./assets/images/search_icon.png') -80px -100px",
            position: "0px -160px",
            url: "https://s.1688.com/selloffer/offer_search.htm?keywords="
        }, {
            name: "知乎",
            img: "url('./assets/images/search_icon.png') -105px -100px",
            position: "-40px -160px",
            url: "https://www.zhihu.com/search?type=content&q="
        }, {
            name: "微博",
            img: "url('./assets/images/search_icon.png') -80px -125px",
            position: "0px -200px",
            url: "https://s.weibo.com/weibo/"
        }, {
            name: "B站",
            img: "url('./assets/images/search_icon.png') -105px -125px",
            position: "-40px -200px",
            url: "http://search.bilibili.com/all?keyword="
        }, {
            name: "豆瓣",
            img: "url('./assets/images/search_icon.png') -80px -150px",
            position: "0px -240px",
            url: "https://www.douban.com/search?source=suggest&q="
        }, {
            name: "优酷",
            img: "url('./assets/images/search_icon.png') -105px -150px",
            position: "-40px -240px",
            url: "https://so.youku.com/search_video/q_"
        }, {
            name: "GitHub",
            img: "url('./assets/images/search_icon.png') -80px -175px",
            position: "0px -280px",
            ...
            success: function (res) {
                ...
                if (hotList) {
                    ...
                    for (var i = 0; i < hotList; i++) {
                        ...
                        if (i === 0) {
                            $("#box ul li").eq(i).css({"border-top": "none"});
...
$("#server-save").click(function () {
    if (!ifLogin) {
        $.ajax({
            ...
            error: function () {
                layer.confirm("似乎发送了点意外，请先本地保存，然后重新登录再进行下一步操作。", {
                    icon: 2,
                    title: "错误提示",
                    btn: ["本地保存", "取消"]
                }, function (index) {
                    ...
                    localSave();
                    $.ajax({
                        type: "POST", url: "/api/v1/users/actions/logout", success: function () {
                            setTimeout(function () {
                                location.reload()
                            }, 1500)
                        }
        ...
        layer.confirm("你当前未登录，请登录后再进行操作.<br/>是否先本地保存？", {
            icon: 2,
            title: "错误提示",
            btn: ["本地保存", "取消"]
        }, function (index) {
...
function syncData() {
    if (!ifLogin) {
        if (userID) {
            $.ajax({
                type: "GET", url: "/api/v1/users/" + userID, success: function (res) {
...
function submitRegister() {
    ...
    if (ifForm) {
        $.ajax({
            ...
            headers: {"Content-Type": "application/json", "X-SS-API-KEY": "8a32a681-724a-4c2b-8e57-a7af37b48260",},
            data: JSON.stringify({
                "userName": retVal[0][0].value,
                "password": retVal[0][1].value,
                "email": retVal[0][2].value
            }),
            success: function (res) {
...
function selectTheme(self, hide, bg, bgclassone, bgclasstwo, indexs) {
    ...
    if (clickIndex === 0) {
        ...
        if (clickIndex > 0 && clickIndex < 8) {
            ...
            $("header").removeClass().addClass("header-diy" + clickIndex);
            themeData.data[0] = 1;
            ...
            $("header").removeClass().addClass(thisClass + "-head");
            themeData.data[0] = 2;
            themeData.data[1] = clickIndex
        }
    }
